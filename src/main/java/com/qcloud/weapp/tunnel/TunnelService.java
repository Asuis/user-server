...
public class TunnelService {
	 ...
	 */
	public void handle(com.qcloud.weapp.tunnel.TunnelHandler handler, TunnelHandleOptions options) throws ConfigurationException {
	 ...
	 */
	private void handleGet(com.qcloud.weapp.tunnel.TunnelHandler handler, TunnelHandleOptions options) throws ConfigurationException {
		Tunnel tunnel = null;
		UserInfo user = null;
	...
	private void handlePost(TunnelHandler handler, TunnelHandleOptions options) throws ConfigurationException {
		...
		// 3. 检查报文签名
		String computedSignature = Hash.sha1(data + com.qcloud.weapp.tunnel.TunnelClient.getKey());

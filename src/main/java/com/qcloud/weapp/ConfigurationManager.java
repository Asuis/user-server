...
public class ConfigurationManager {
	...
	private static com.qcloud.weapp.Configuration currentConfiguration;
	
	/**
	 * 获取当前的 SDK 配置
	 * */
	public static com.qcloud.weapp.Configuration getCurrentConfiguration() throws ConfigurationException {
	 ...
	 * */
	public static void setup(com.qcloud.weapp.Configuration configuration) throws ConfigurationException {
	...
	public static void setupFromFile(String configFilePath) throws JSONException, ConfigurationException {
		...
		com.qcloud.weapp.Configuration configuration = new Configuration();
